...
<body>
	...
	<h3>选择员工信息Excel表格文件（.xls 格式）</h3>
	<form name="form0" action="epDataController.do?impEmpInfo" method="post" enctype="multipart/form-data">
		<input type="file" name="emp_info_xls"> <input type="submit" value="upload" />
	</form>
	<hr>
