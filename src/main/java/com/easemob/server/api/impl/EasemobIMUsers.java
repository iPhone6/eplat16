...
import com.easemob.server.comm.body.EmptyBody;
...
public class EasemobIMUsers extends EasemobRestAPI implements IMUserAPI {
	...
	public Object loginIMUser(Object payload) {
		String url = getContext().getSeriveURL() + "/token";
	...
	public Object getFriends(String userName) {
        ...
        HeaderWrapper header = HeaderHelper.getDefaultHeaderWithToken();
//        BodyWrapper body = new EmptyBody();
