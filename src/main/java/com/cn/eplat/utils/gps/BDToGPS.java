 ...
 * @author fankun
 * 
 * REF: java代码火星坐标系转GPS标准坐标系
 *      http://www.itdadao.com/articles/c15a560315p0.html
 *      原文 http://blog.csdn.net/qq1072313099/article/details/52467972
 * 
 */
public class BDToGPS {
	...
	public static double[] bd092WGS(double glat, double glon) {
		System.out.println("WWW==纬度:" + glat);
		System.out.println("WWW==经度:" + glon);
	...
	public static void main(String[] args) {
		double in_lat = 22.6391143100;
		double in_lng = 114.0606038169;
		
		double[] ret = gcj2WGSExactly(in_lat, in_lng);
		System.out.println("转换之后的纬度：" + ret[0]);
		System.out.println("转换之后的经度：" + ret[1]);
		
		/*
		 * 转换之后的纬度：22.641822877380903
			转换之后的经度：114.05548632541633
			res = 0.0
		 */
		...
		double res = distance(latA, logA, latB, logB);
