...
public interface IRestCalendarDao {
	
	//批量插入休息日期
	public int insertRestCalendar(List<HashMap<String, Object>> datas);
	
	//查找开始和结束日期之间的所有休息日期
	public List<HashMap<String,Object>> getDatesBetweenStartAndEnd(@Param("startdate") Date startDate,@Param("enddate") Date endDate);
