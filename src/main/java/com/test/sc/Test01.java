...
//		}
		...
		System.out.println("0.2*0.1 = "+0.2*0.1);	// 0.2*0.1 = 0.020000000000000004
		System.out.println("0.2+0.1 = "+(0.2+0.1));	// 0.2+0.1 = 0.30000000000000004
		System.out.println("3*0.1 = "+3*0.1);		// 3*0.1 = 0.30000000000000004
